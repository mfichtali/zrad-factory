...
@Entity
@Table(name = TableNameUtils.T_VEHICLE_TRIP_QUARTERLY_SUMMARY, schema = TableNameUtils.ZRAD_DEFAULT_SCHEMA)
@NoArgsConstructor
...
@DynamicUpdate
@DynamicInsert
public class VehicleTripQuarterlySummary extends AbstractZradEntity {
    ...
    @ToString.Include
    @EqualsAndHashCode.Include
    @Column(name = "LB_QUARTER", nullable = false)
