...
@Entity
@Table(name = TableNameUtils.T_VEHICLE_TRIP_MONTHLY_SUMMARY, schema = TableNameUtils.ZRAD_DEFAULT_SCHEMA)
@NoArgsConstructor
...
@DynamicUpdate
@DynamicInsert
public class VehicleTripMonthlySummary extends AbstractZradEntity {
