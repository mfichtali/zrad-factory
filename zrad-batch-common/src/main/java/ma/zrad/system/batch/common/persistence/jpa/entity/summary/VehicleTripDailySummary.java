...
@Entity
@Table(name = TableNameUtils.T_VEHICLE_TRIP_DAILY_SUMMARY, schema = TableNameUtils.ZRAD_DEFAULT_SCHEMA)
@NoArgsConstructor
...
@DynamicUpdate
@DynamicInsert
public class VehicleTripDailySummary extends AbstractZradEntity {
