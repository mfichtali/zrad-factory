package ma.zrad.system.stats.batch.listener;
...
public class BatchTripStatsListener implements JobExecutionListener {
    ...
    public void beforeJob(final JobExecution jobExecution) {
        ...
        var eventCtx = EventBusinessDomain.buildStartedEvent(EventBatchContextEnum.ZRAD03);
        eventCtx.setEventBusinessTypeEnum(EventBusinessTypeEnum.VEHICLE_TRIP_STATS);
        ...
        context.put(BatchConstantUtils.BATCH_CTX_TRIP_STATS_EVENT_ID, eventBusinessCtx.getId());
    }

    @Override
    public void afterJob(final JobExecution jobExecution) {
        ExecutionContext context = jobExecution.getExecutionContext();
        var eventCtxIdentifier = (UUID) context.get(BatchConstantUtils.BATCH_CTX_TRIP_STATS_EVENT_ID);
