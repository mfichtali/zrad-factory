package ma.zrad.system.metrics.batch.api.feign.region;

import ma.zrad.system.batch.common.pojo.FullRegionDetailsOut;
import ma.zrad.system.metrics.batch.api.feign.common.AbstractClientFeign;
import ma.zrad.system.metrics.batch.api.feign.common.FeignSupportConfig;
...
import static ma.zrad.system.metrics.batch.api.feign.common.AbstractClientFeign.REF_CORE_SERVICE_NAME;
import static ma.zrad.system.metrics.batch.api.feign.common.AbstractClientFeign.REF_CORE_SERVICE_URL;
