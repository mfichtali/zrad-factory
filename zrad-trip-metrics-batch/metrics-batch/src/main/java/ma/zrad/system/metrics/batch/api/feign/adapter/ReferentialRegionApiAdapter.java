package ma.zrad.system.metrics.batch.api.feign.adapter;

import lombok.RequiredArgsConstructor;
import ma.zrad.system.batch.common.pojo.FullRegionDetailsOut;
import ma.zrad.system.metrics.batch.api.feign.region.ReferentialRegionClientFeign;
import ma.zrad.system.metrics.batch.domain.port.out.ReferentialRegionApiPort;
