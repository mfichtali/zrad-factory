package ma.zrad.system.metrics.batch.infra.config;
...
import static ma.zrad.system.metrics.batch.infra.config.ZradScanPackages.BATCH_COMMON_PERSISTENCE_ENTITY_SCAN;
import static ma.zrad.system.metrics.batch.infra.config.ZradScanPackages.INFRA_REPOSITORY;
...
@EnableJpaRepositories(
        ...
        entityManagerFactoryRef = ZradDbConfig.ENTITY_MANAGER_FACTORY_REF,
        transactionManagerRef = ZradDbConfig.TRANSACTION_MANAGER_REF)
