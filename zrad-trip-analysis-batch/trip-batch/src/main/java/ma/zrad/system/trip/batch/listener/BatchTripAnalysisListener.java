package ma.zrad.system.trip.batch.listener;
...
public class BatchTripAnalysisListener implements JobExecutionListener {
    ...
    public void beforeJob(final JobExecution jobExecution) {
        ...
        var eventCtx = EventBusinessDomain.buildStartedEvent(EventBatchContextEnum.ZRAD02);
        eventCtx.setEventBusinessTypeEnum(EventBusinessTypeEnum.VEHICLE_TRIP_ANALYSIS);
